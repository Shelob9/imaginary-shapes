...
describe("Urgent", () => {
	const items = [
		{ urgency: 1, importance: 10, title: "U:1", id: "1" },
		{ urgency: 4, importance: 1, title: "U:4", id: "1" },
		{ urgency: 5, importance: 1, title: "U:5", id: "1" },
		{ urgency: 6, importance: 1, title: "U:6", id: "1" },
		{ urgency: 3, importance: 10, title: "U:3:I10", id: "1" },
	];
...
describe("Urgent Sort", () => {
	it("When urgency is tied, more important task wins", () => {
		const items = [
			{ urgency: 8, importance: 8, title: "U:8:I8", id: "1" },
			{ urgency: 8, importance: 9, title: "U:8:I9", id: "1" },
		];
	...
	it("Gives prefrence to fun", () => {
		const items: savedItemsCollection = [
