...
describe('Quadrants', () => {
  test('Important, not urgent is in right, not left', () => {
    const items = [
      { urgency: 3, importance: 7, title: 'U:3:I7' },
      { urgency: 10, importance: 7, title: 'U:10:I7' },
    ];
  ...
  test('Top Left Can Be Empty', () => {
    const r = quadrants([
      { urgency: 3, importance: 7, title: 'ImportantNotUrgent' },
      { urgency: 2, importance: 2, title: 'NotUrgentAndNotImportant' },
      { urgency: 10, importance: 3, title: 'UrgentNotImportant' },
    ]);
    expect(r.topLeft).toEqual([]);
  });
  test('Top Right Can Be Empty', () => {
    const r = quadrants([
      { urgency: 10, importance: 7, title: 'UrgentAndImportant' },
      { urgency: 2, importance: 2, title: 'NotUrgentAndNotImportant' },
      { urgency: 10, importance: 3, title: 'UrgentNotImportant' },
    ]);
