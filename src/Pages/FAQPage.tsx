/** @jsx jsx */
import { jsx, Box, Grid, Styled, Container } from "theme-ui";
...
const FAQPage = () => {
	return (
		<Container>
			...
			>
				<Grid>
					<Styled.h1>Imaginary Shapes: FAQ</Styled.h1>
					...
					>
						<Styled.p>
							...
							Blockstack is that your data is encrypted so no one, including me
							can read it or sell it. It's yours not mine or Amazons'.
						</Styled.p>
					</FAQItem>
					<FAQItem
					...
					>
						<Styled.p>
							...
							<Styled.a href="https://dev.to/shelob9">
								Dev.to or whatever
							</Styled.a>
					...
					<FAQItem q={"Who Made This And Why?"} link={"https://joshpress.net"}>
						<Styled.p>
							Hi, I'm Josh. I'm a JavaScript and PHP developer from Pittsburgh,
							PA. I pulled this web application together during Coronovirus
							pandmemic using a bunch of stuff I wrote on airplanes while half
							asleep during the previous years.
						</Styled.p>
					</FAQItem>
